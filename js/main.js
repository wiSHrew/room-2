...
//tv
const tvG = new THREE.BoxGeometry( 4, 2, 1. );
...
const tvScreenG = new THREE.BoxGeometry( 3.9, 1.9, 1.11 );
const tvScreenM = new THREE.MeshStandardMaterial({color: 0xffffff});
